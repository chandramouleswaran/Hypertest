...
{
    [FileContent("Web test files", "*.tsc", 1)]
    [NewContent("Web test files", 1, "Creates a new web test file", "pack://application:,,,/Hypertest;component/Hypertest.png")]
    class WebTestFileHandler : IContentHandler
    {
        /// <summary>
        ...
        public WebTestFileHandler(IUnityContainer container, ILoggerService loggerService)
        {
        ...
        public bool ValidateContentType(object info)
        {
            ...
            return File.Exists(location) && extension == ".tsc";
        }
